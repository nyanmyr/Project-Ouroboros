...
public class IntroSequence extends javax.swing.JFrame {

    public IntroSequence() {
        initComponents();
        

        setExtendedState(IntroSequence.MAXIMIZED_BOTH);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntroSequence().setVisible(true);
            }
        });
    }
